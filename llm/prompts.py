...
POST_RELEVANCE_FILTER_PROMPT = """Determine if the following LinkedIn post is professionally relevant to the user based on their profile.
...
A post is relevant if it discusses topics, industries, tech stacks, skills, or opportunities that align with the user's interests, skills, title, or target domain. For example, if a user is in tech or AI, posts about engineering, AI, technology, startup collaborations, hiring within tech, or speaking events are relevant. General life updates, non-business memes, or completely unrelated fields are not relevant.
